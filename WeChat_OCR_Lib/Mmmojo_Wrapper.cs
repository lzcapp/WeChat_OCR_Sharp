...
namespace WeChat_OCR_Lib {
    ...
    internal class Mmmojo_Wrapper {
        ...
        public static IntPtr CreateMMMojoEnvironment() {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.CreateMMMojoEnvironment() : Mmmojo_x86.CreateMMMojoEnvironment();
        }
        ...
        public static IntPtr GetMMMojoReadInfoRequest(IntPtr mmmojo_readinfo, ref uint requestDataSize) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.GetMMMojoReadInfoRequest(mmmojo_readinfo, ref requestDataSize) : Mmmojo_x86.GetMMMojoReadInfoRequest(mmmojo_readinfo, ref requestDataSize);
        }

        public static IntPtr GetMMMojoReadInfoAttach(IntPtr mmmojo_readinfo, ref uint attachDataSize) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.GetMMMojoReadInfoAttach(mmmojo_readinfo, ref attachDataSize) : Mmmojo_x86.GetMMMojoReadInfoAttach(mmmojo_readinfo, ref attachDataSize);
        }
        ...
        public static int GetMMMojoReadInfoMethod(IntPtr mmmojo_readinfo) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.GetMMMojoReadInfoMethod(mmmojo_readinfo) : Mmmojo_x86.GetMMMojoReadInfoMethod(mmmojo_readinfo);
        }

        public static bool GetMMMojoReadInfoSync(IntPtr mmmojo_readinfo) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.GetMMMojoReadInfoSync(mmmojo_readinfo) : Mmmojo_x86.GetMMMojoReadInfoSync(mmmojo_readinfo);
        }

        public static IntPtr CreateMMMojoWriteInfo(int method, int sync, uint requestId) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.CreateMMMojoWriteInfo(method, sync, requestId) : Mmmojo_x86.CreateMMMojoWriteInfo(method, sync, requestId);
        }

        public static IntPtr GetMMMojoWriteInfoRequest(IntPtr mmmojo_writeinfo, uint requestDataSize) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.GetMMMojoWriteInfoRequest(mmmojo_writeinfo, requestDataSize) : Mmmojo_x86.GetMMMojoWriteInfoRequest(mmmojo_writeinfo, requestDataSize);
        }
        ...
        public static IntPtr GetMMMojoWriteInfoAttach(IntPtr mmmojo_writeinfo, uint attachDataSize) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.GetMMMojoWriteInfoAttach(mmmojo_writeinfo, attachDataSize) : Mmmojo_x86.GetMMMojoWriteInfoAttach(mmmojo_writeinfo, attachDataSize);
        }
        ...
        public static bool SendMMMojoWriteInfo(IntPtr mmmojo_env, IntPtr mmmojo_writeinfo) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.SendMMMojoWriteInfo(mmmojo_env, mmmojo_writeinfo) : Mmmojo_x86.SendMMMojoWriteInfo(mmmojo_env, mmmojo_writeinfo);
        }

        public static bool SwapMMMojoWriteInfoCallback(IntPtr mmmojo_writeinfo, IntPtr mmmojo_readinfo) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.SwapMMMojoWriteInfoCallback(mmmojo_writeinfo, mmmojo_readinfo) : Mmmojo_x86.SwapMMMojoWriteInfoCallback(mmmojo_writeinfo, mmmojo_readinfo);
        }

        public static bool SwapMMMojoWriteInfoMessage(IntPtr mmmojo_writeinfo, IntPtr mmmojo_readinfo) {
            return SystemHandling.Is64BitOperatingSystem() ? Mmmojo_x64.SwapMMMojoWriteInfoMessage(mmmojo_writeinfo, mmmojo_readinfo) : Mmmojo_x86.SwapMMMojoWriteInfoMessage(mmmojo_writeinfo, mmmojo_readinfo);
        }
    }
}