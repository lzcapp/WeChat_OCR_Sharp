...
internal class Mmmojo_x86 {
    private const string MojoDllName = "mmmojo.dll";
    ...
    [DllImport(MojoDllName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern void AppendMMSubProcessSwitchNative(IntPtr mmmojo_env, IntPtr switchStringPtr,
        IntPtr valuePtr);
